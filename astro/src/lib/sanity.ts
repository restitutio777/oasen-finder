...
/**
 * Übersetzungs-Erkennung — die Logik liegt in translations.js (reines JS,
 * damit `npm test` sie prüfen kann; siehe translations.test.js). Hier nur
 * durchgereicht, damit Komponenten wie gewohnt aus lib/sanity importieren.
 */
export { availableTranslations } from './translations.js';
